"""
Главный цикл: generate -> verify -> filter -> save.

Пример запуска: см. scripts/run_pipeline.py
"""
...
def run(
    ...
    """
    statements: список формулировок теорем (строки Lean4, например
    ...
    for statement in statements:
        ...
        for candidate in candidates:
            total += 1
            full_code = f"{statement} := {candidate}" if ":=" not in statement else candidate
